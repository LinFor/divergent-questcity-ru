...
function timer(){
 ...
 obj.innerHTML--;
 if(obj.innerHTML==0){
 location = "https://<?php echo $_SERVER['HTTP_HOST']; ?>"
 setTimeout(function(){},1000);}
 else{setTimeout(timer,1000);}
}
setTimeout(timer,1000);
</script>
<noscript><meta http-equiv="refresh" content="10; url=https://<?php echo $_SERVER['HTTP_HOST']; ?>"></noscript>


<div class="top">
<h1>Ошибка 404. Такой страницы нет.</h1>
<small>Перенапраление на на главную через <b id="timer_inp">10</b> сек.</small>
<span>Перейти на <a href="https://<?php echo $_SERVER['HTTP_HOST']; ?>"><?php echo $_SERVER['HTTP_HOST']; ?></a></span>
</div>

</div>

<div class="copy">
&copy; <?php echo date('Y'); ?> <a href="https://<?php echo $_SERVER['HTTP_HOST']; ?>"><?php echo $_SERVER['HTTP_HOST']; ?></a>
</div>
