...
document.write('<table id="fc" style="display:none;" cellpadding="3">');
...
//document.write('<tr><td colspan="7" align="center" style="cursor:pointer;font:13px;background:#B5B5B9; color:#fff;" onclick="today()" class="cl_today"><?php echo $lang['today']; ?>: '+addnull(sccd,sccm+1,sccy)+'</td></tr>');
